...
describe 'raindrops', ->
  ...
  it 'the sound for 3 is Pling', ->
    ...
    result = raindrops 3
    assert.are.same result, 'Pling'

  it 'the sound for 5 is Plang', ->

    result = raindrops 5
    assert.are.same result, 'Plang'

  it 'the sound for 7 is Plong', ->

    result = raindrops 7
    assert.are.same result, 'Plong'
  ...
  it 'the sound for 15 is PlingPlang as it has factors 3 and 5', ->
    ...
    result = raindrops 15
    assert.are.same result, 'PlingPlang'

  it 'the sound for 21 is PlingPlong as it has factors 3 and 7', ->

    result = raindrops 21
    assert.are.same result, 'PlingPlong'
  ...
  it 'the sound for 35 is PlangPlong as it has factors 5 and 7', ->
    ...
    result = raindrops 35
    assert.are.same result, 'PlangPlong'
